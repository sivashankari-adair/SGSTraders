...
public class TamilFont {
    ...
    public static String initialize(String text) {
        ...
        text = text.replace("சௌ", "sov");
        text = text.replace("சோ", "soo");
        text = text.replace("சொ", "sow");
        text = text.replace("சா", "saa");
        text = text.replace("சி", "si");
        text = text.replace("சீ", "sii");
        text = text.replace("சு", "su");
        ...
        text = text.replace("ள்", "il;");
        text = text.replace("ள", "la");
